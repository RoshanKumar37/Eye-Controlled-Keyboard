...
board = np.zeros((200, 1100), np.uint8)
board[:] = 255

detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor("eyeKeyboard\shape_predictor_68_face_landmarks.dat")
...
while True:
    ...
    for face in faces:
        ...
        if select_keyboard_menu is True:
            ...
            if blinking_ratio > 5:
                #cv2.putText(frame,
                # "BLINKING", (50, 150), font, 4, (255, 0, 0), thickness=3)
                blinking_frames += 1
                frames -= 1
